export const CartIcon = ({fill, width, height}: {fill?: string, width?: string, height?: string}) => {
    return(

        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={width ? width : '512'} height={height ? height : '512'} fill={fill ? fill : 'black'}>

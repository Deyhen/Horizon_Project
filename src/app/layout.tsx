...
const RootLayout = ({
  ...
  return (
    <html lang="en" suppressHydrationWarning={true}>
      ...
      <StoreProvider>
        <body className="grid grid-cols-[1fr] grid-rows-[15rem,auto,1fr,10rem] md:grid-cols-[1fr,24rem] md:grid-rows-[40rem,1fr,20rem]">
          ...
          <Header />
          <main className="col-span-2 col-start-1 row-start-3 flex w-full items-start justify-center px-4 md:col-span-1 md:row-start-2 md:mt-40">
            {children}
          </main>
          <RightBar />
          <Footer />

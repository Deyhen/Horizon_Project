...
export default function NavBar() {
  ...
  const after =
    'after:origin-center after:duration-700 hover:after:block after:w-0 after:h-1 hover:after:bg-[#e77f2a] hover:after:absolute hover:after:-translate-x-1/2 hover:after:w-full hover:after:left-1/2';
